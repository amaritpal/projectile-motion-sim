...
public class Simulation {
    ...
    private void saveGraph() {
        if (physicsEngine != null && !isRunning) {
            ...
            System.out.println("Saving Trajectory Data:");
            graphData.trajectoryData().forEach(point ->
    ...
    private void loadGraph() {
        ...
        if (!savedGraphs.isEmpty()) {
            ...
            if (selectedIndex != -1) {
                ...
                System.out.println("Trajectory Data Points:");
                selectedGraph.trajectoryData().forEach(dp ->
                        System.out.printf("X: %.2f, Y: %.2f\n", dp.getX(), dp.getY())
                );
                ...
                for (DataPoint point : selectedGraph.trajectoryData()) {
                    ...
                    System.out.printf("Drawing point at transformed coordinates -> X: %.2f, Y: %.2f\n", coords[0], coords[1]);
