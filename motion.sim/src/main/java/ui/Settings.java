...
public class Settings {
     ...
     * This scene contains various settings options such as volume, FPS, and theme.
     * The settings are persisted using the SettingsManager class.
     *
    ...
    public Scene createSettingsScene() {
        ...
        volumeSlider.valueProperty().addListener((obs, oldValue, newValue) -> {
            ...
            SettingsManager.setVolume(newValue.intValue());
        });
